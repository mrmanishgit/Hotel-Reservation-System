...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel_management_system/icons/nine.jpg"));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText(); //room_number;    
                                ...
                                c.s.executeUpdate("update customer set roomnumber = '"+s2+"', name = '"+s3+"', status = '"+s4+"', deposit = '"+s5+"' where numbers = '"+s1+"'");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String s1 = c1.getSelectedItem();
				conn c = new conn();
                                ResultSet rs1 = c.s.executeQuery("select * from customer where numbers = "+s1);
