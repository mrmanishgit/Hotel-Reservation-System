...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("hotel_management_system/icons/tick.png"));
                ...
                l2.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            conn c = new conn();
                            String numbers = c1.getSelectedItem();
                            ResultSet rs = c.s.executeQuery("select * from customer where numbers = "+numbers);
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where numbers = "+id;
